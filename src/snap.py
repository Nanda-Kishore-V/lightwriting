...
class QrPath:
	def __init__(self, x, y, z, psi, power=10.00, tilt=None, guess=5.00):
		...
		# should make this to be user input

		# physical constants
		self.m = 0.033		# total mass [kg]
		self.g = 9.81		# acceleration of gravity [m/s^2]
		self.Ix = 16.6e-6	# longitudinal inertia [kgm^2]
		self.Iy = 16.7e-6	# lateral inertia [kgm^2]
	...
	def optimize(self):
		...
		self.k = k_res.x[0]
		T = self.Tr * self.k # segment of each path * total time = time for each path
